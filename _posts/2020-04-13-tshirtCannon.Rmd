...
So the best row to sit in is row `r maxRow`.  
...
This may be counterintuitive.  Looking at the figure below, it is easy to see what is going on.  I've plotted the row the projectile lands in vs. the launch angle.  The projectile row lands in row 100 between `r minAngle` deg and `r maxAngle` deg.  This is a range of `r maxAngle-minAngle` degrees.  No other row has even half of that range of angles.  It is the fact that the derivative of the range function is so small near an angle of 45 degrees, that makes the range change so little as the launch angle changes.
