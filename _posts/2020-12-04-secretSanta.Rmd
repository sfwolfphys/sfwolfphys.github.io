...
knitr::opts_chunk$set(fig.path = "figure/2020-12-04-secretSanta/")
```
...
The probability that nobody gets their own name is: `r round(prob,4)` or $$\frac{11}{30}$$.
...
Out of 120 possible drawings, there are `r nrow(drawFails)` failures.  
