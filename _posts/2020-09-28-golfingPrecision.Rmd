...
knitr::opts_chunk$set(fig.path = "figure/2020-09-28-golfingPrecision/")
```
...
xBad = 1 - (c/d0)^(1/6)
```
So you need to be within `r round(x*100,2)`% (Rounded to 2 decimal places).
...
- Bogey: `r round(xBogey*100,2)`%
- Birdie: `r round(xBirdie*100,2)`%

And if you are a bad golfer like me, you've never broken 100, so that's `r round(xBad*100,2)`%.  If you just like [Bad Golf, then these guys are for you](https://www.youtube.com/channel/UCrEkTg1razLTBO42AgJsz_w).
